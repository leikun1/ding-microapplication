<template>
    <div class="field">
        ...
        <div class="control">
            ...
            <img :src="(value != '' && value !== null) ? value : defaultImg"  :alt="name" @click="openCamera()" style="height: 100%;width: 100%; max-height:200px;max-width:220px;">
        </div>
    </div>
</template>
<script>
    ...
    export default {
        ...
        methods: {
            ...
            openCamera: function() {   // 调用企业微信 打开摄像头
              let _this=this
              _this.$VuePlus.camera().then(function (path) {
